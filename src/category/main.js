    ...
    if (type === BillType.Expend) {
        rules = Object.assign(
            publicRule,
            {
                ...
                "快递":
                    /[快速][递运]|兔喜生活|百世汇通|物流|宅急送|(邮|寄[送件])费|丰巢|(妈妈|菜鸟)驿站|菜鸟裹裹|代收|投递站|邮政|EMS/i,
                ...
                "医疗":
                    /医([院馆生护用药]|.?室)|药([店房号业厂]|匣子)|诊所|卫生(服务(中心|站)|[院所室])|老百姓|海王星辰|\bLBX\b|(同仁|九芝)堂|甘之草科技|三七|黄芪|枸杞|菊花|甘草|红花|当归|石斛|凉茶|([白红沙玄党苦人]|西洋|花旗|太子)参|海(马|狗肾)|妇幼保健/,
