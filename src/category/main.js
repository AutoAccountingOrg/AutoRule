import { BillType } from '../utils/index.js';
import { isTimeInRange } from '../utils/index.js';
export function get(money, type, shopName, shopItem, time) {
  ...
  if (type === BillType.Expend) {
    rules = Object.assign(publicRule, {
      "三餐": /([煨煮卤饺馍]|[^零]?食(?!戟之灵|的俘虏|.*争霸|[品物用神气人])|[^小灰]?汤(?![氏记家姆阴山泉河浴]|臣倍健|.?[村乡镇县市州])|煎(?![锅药])|炖(?![盅锅])|[^代套]?餐(?![具盘巾勺桌椅])|炒(?![锅勺冰货]|板栗|栗子)|蒸(?![笼屉锅片布箱柜汽]|桑拿)|[^爆轰]?炸(?![弹锅开药])|烤(?![箱架盘火炉盆])|[^喂]?饭(?![碗锅勺圈]))(?!.*([用器节]|套装|工具))|([烙馅灌飞剁烧]|千层|油酥|扣肉|酱香)饼|[火香干]锅|[粉面][店馆]|[家土]菜馆|[包早]点|([鲜汤大肉]|小笼)包|油条|([卤鱼渔拌凉]|螺蛳|[牛羊猪].{0,3}|花甲|石磨|.[杂脚蹄肉]|[海越]南)粉|(手工|[拉粉冷凉捞]|(biang|[担旦]){2}|刀削|[牛羊猪].{0,3}|[炸杂]酱|.[杂脚肉])[面麵麺]|锅盔|(特色|地方|家常|私房|[湘川鲁粤闵徽浙宽冒]|淮扬|江湖)菜|鸡公煲|新芙蓉|民间沙水|大米先生|老盛昌|爆好呷|李丸外|辣有味|沙县小吃|大排档|黑色[经金精]典|馄饨|麻辣|臭(豆腐|干子)|自助(海鲜|$|：)|[鸡牛羊]排|肯德基|麦当劳|疆尕尕|(德克|华莱)士|pizza|[披批比匹]萨|寿司|料理|汉堡|和宴厨|生鲜|蔬菜|菜铺|水产|干货|副食|豆制品/i,
      ...
      "购物": /小卖部|拼多多|[保免]税店|七件事|蔚然锦和|超市|便利|建材|五金|.*客隆|家.{0,2}福|快乐惠|世纪联华|联华超市|大润发|华润万家|苏果|沃尔玛|物美|新一佳|好又多|华联|文峰大世界|TESCO乐购|易初莲花|麦德龙|中百连锁仓储|人人乐|家家悦|潍坊百货|欧尚|永辉|武商量贩|新华都|步步高商业|永旺|红旗连锁|三江购物|互惠|美廉美|百佳超市|易买得|维客|美特好|保龙仓|华普|利客来|良友金伴|美宜佳|华冠|家润多|华之友|好家乡|惠友|民生家乐|思达|雅家乐|天惠|新江厦|喜洋洋|乐尔乐|汇米巴|家[用居具]|厨[房具]|工具|[餐炒炖炸蒸烤食煨煮卤饺煎馍](?=.*[用器])|炖[盅锅]|餐[具盘巾勺桌椅]|炒[锅勺冰板栗用]|蒸[笼屉锅片布箱柜]|炸[锅]|烤[箱架盘火炉]|饭[碗锅勺]|枕头|[床被][单套]|床上用品|凉席|阀门|开关|扎带|购物/,
