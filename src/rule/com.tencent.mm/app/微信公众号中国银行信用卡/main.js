import { formatDate, isPaymentType, parseWechat, RuleObject, splitShop, toFloat } from 'common/index.js';
...
const rules = [
  [
    ...
    match => {
      ...
      let { matchType, typeName } = isPaymentType(type, ['购汇']);
      let { shopName, shopItem } = splitShop(type, type2);
